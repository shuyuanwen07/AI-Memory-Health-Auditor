...
export function GroundTruthReview({ memories, busy, onChange, onAddMemory, onConfirm }: Props) {
  ...
  return <section aria-labelledby="ground-truth-title">
    ...
    <p>Review the memories identified from the conversation. Accept records that are correct, edit records that need clarification, and reject records that should not become audit ground truth.</p>
