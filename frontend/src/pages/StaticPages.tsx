...
function ExperimentHistoryCard({ experiment, report, exporting, onDownload, onDownloadBundle, onDownloadArtifact }: { experiment: Experiment; report?: ExperimentAnalytics; exporting: boolean; onDownload: (experiment: Experiment) => void; onDownloadBundle: (experiment: Experiment) => void; onDownloadArtifact: (experiment: Experiment) => void }) {
