...
Optional target-AI selections are available for OpenAI GPT-5.6 Luna, DeepSeek Flash, Gemini 2.5 Flash-Lite, and local Qwen 3 1.7B through Ollama. Put cloud-provider keys or the local Ollama endpoint configuration in `.env`; see [development instructions](docs/DEVELOPMENT.md).
